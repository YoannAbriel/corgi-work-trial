...
| B5-MC | MED | The live refund of $3,241.56 crossed the $1,000 money-out threshold with no human approver because maker-checker (B7) does not exist yet | B7 inserts the approval queue between recordCancellation and issueRefundsAtStripe | OPEN, disclosed (B7) |
